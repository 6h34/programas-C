...
//LISTA PRATICA 5 - ATIVIDADE 3
//O objetivo do programa ter como entrada do usuario um numero n, de valores ,que serao lidos pelo usuario,
//tirar a media dos numeros positivos e negativos, caso seja registrado um n negativo, o programa deve ser encerrado.
...
int main(){
    ...
    for (x=1;x<n+1;x++){ //os n numeros que serao lidos pelo teclado
        ...
        int n1; 
        scanf("%d",&n1);
        if (n1 < 0){ // se for um n negativo o programa executará essa operacao para terminar o programa.
